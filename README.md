...
**⚠️ Notes**
For personal/educational use only. Scraping commercial sites may violate their Terms of Service. Use responsibly!

If Amazon uses CAPTCHAs, 2FA, or changes its layout, the script may require updates.

Browser automation with Selenium may require ChromeDriver to be in your PATH, or specify its location in the script:
